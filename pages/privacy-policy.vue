<template>
  <section class="container my-4 card p-3">
    <h2 class="text-primary fw-bold text-center my-4">Privacy Policy</h2>
    <div class="row mb-2 d-md-none">
      <div class="col-md-6 col-lg-6 col-12 ps-md-5">
        <div class="d-flex justify-content-center align-items-center">
          <img
            src="~/assets/svg/policy.svg"
            class="img-fluid z-index-1"
      ...
      <div class="row col-12 d-flex justify-content-center p-4">
        <p>
          At <span class="text-info fw-bold">Upasthiti</span>, accessible from
          <NuxtLink to="/" class="link-info fw-bold">Upasthiti</NuxtLink>, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by
          <NuxtLink to="/" class="link-info fw-bold">Upasthiti</NuxtLink>
          and how we use it.
        </p>
        ...
        <p>
          ...
          <NuxtLink to="/" class="link-info fw-bold">Upasthiti</NuxtLink>. This
        ...
        <p>
          <span class="text-info fw-bold">Upasthiti</span> follows a standard
        ...
        <p>
          <span class="text-info fw-bold">Upasthiti's</span> Privacy Policy does
        ...
        <p>
          <span class="text-info fw-bold">Upasthiti</span> does not knowingly
    ...
    <div class="privacy-block container-fluid d-none d-md-block">
      <div class="row">
        <div class="col vh-70">
        ...
        <div class="col vh-70 overflow-scroll">
          <p>
            At <span class="text-info fw-bold">Upasthiti</span>, accessible from
            <NuxtLink to="/" class="link-info fw-bold">Upasthiti</NuxtLink>, one
            of our main priorities is the privacy of our visitors. This Privacy
          ...
          <p>
            <span class="text-info fw-bold">Upasthiti's</span> Privacy Policy
