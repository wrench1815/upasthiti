    ...
    <div class="card">
      <div class="card-header">
        ...
        <h3 class="text-secondary text-capitalize">
          ...
          <span class="text-info fw-bold" v-else>{{ attendance.id }}</span>
        </h3>
      </div>
      ...
      <div class="card-body">
        <transition name="scale-in" mode="out-in">
          ...
          <ValidationObserver v-slot="{ handleSubmit }" v-else>
            ...
            <form @submit.prevent="handleSubmit(updateAttendance)">
              <div class="row">
                <!--Start:Class -->
              ...
              <div class="d-flex justify-content-center gap-3 flex-wrap mt-2">
                ...
                >
                  <span class="d-flex align-items-center gap-1">
                    <i class="ri-edit-2-line ri-lg mt-n1"></i>
  ...
  methods: {
    ...
    async updateAttendance() {
      try {
        ...
        attendance.for_class = attendance.for_class.id
        ...
        this.$swal({
          ...
          icon: 'info',
          type: 'info',
          text: 'Please wait while we are updating Attendance',
          didOpen: () => {
            this.$swal.showLoading()

            this.$api.attendance
              .update(attendance.id, attendance)
              .then(() => {
        ...
        this.$swal({
          ...
          icon: 'error',
          type: 'error',
          html: `Failed to update Attendance.<br/>Try Again`,
        })
      }
    },
    ...
    async getStudents() {
      ...
      this.studentPayload.classs = this.attendance.for_class.id
