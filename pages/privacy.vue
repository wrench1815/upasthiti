<template>
  <section class="container my-4 card p-3">
    ...
    <div class="row mb-2">
      <div class="col-md-6 col-lg-6 col-12 ps-md-5 my-3">
        <img
          src="~/assets/svg/policy.svg"
          class="img-fluid sticky-md-top z-index-1"
          alt="Privacy Policy illustration"
        />
      </div>

      <div
        class="row col-md-6 col-lg-6 col-12 d-flex justify-content-center p-4 p-md-5"
      >
        <p>
